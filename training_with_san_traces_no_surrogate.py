...
from algorithms.dracm_no_surrogate import DRACMNoSurrogate
...
if __name__ == "__main__":
    ...
    logger.configure(dir="./log/ppo-san-with-optimal-100-bs-64-new-50-no-surrogate", format_strs=['stdout', 'log', 'csv'])
    ...
    sampler_process = MigrationSamplerProcess(baseline=vf_baseline,
                                              ...
                                              normalize_adv=True,
                                              positive_adv=False)
    algo = DRACMNoSurrogate(policy=rnn_policy,
    ...
    trainer = Trainer(train_env=env,
                      ...
                      test_interval=10,
                      save_path='./checkpoints_san_64-bs-new-50-no-surrogate/model_checkpoint_epoch_')

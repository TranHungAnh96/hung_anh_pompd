...
if __name__ == "__main__":
    ...
    logger.configure(dir="./log/ppo-rome-with-optimal-100-bs-64-new-no-surrogate", format_strs=['stdout', 'log', 'csv'])
    ...
    trainer = Trainer(train_env=env,
                      ...
                      test_interval=10,
                      save_path = './checkpoints_rome-ppo-no-surrogate/model_checkpoint_epoch_')

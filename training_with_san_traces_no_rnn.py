...
if __name__ == "__main__":
    ...
    logger.configure(dir="./log/ppo-san-with-optimal-100-bs-64-new-50-no-rnn", format_strs=['stdout', 'log', 'csv'])
    ...
    trainer = Trainer(train_env=env,
                      ...
                      test_interval=10,
                      save_path='./checkpoints_san_64-bs-new-50-no-rnn/model_checkpoint_epoch_')

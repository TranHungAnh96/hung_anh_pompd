...
# Sua o day experiment collector nhe, them bot parameter vao
...
if __name__ == "__main__":
    ...
    env_default_parameters = EnvironmentParameters(trace_start_index=201,
                                                   ...
                                                   ratio_lower_bound=100.0,ratio_higher_bound=3200.0,
                                                   server_result_data_lower_bound=(0.1 * 1024.0 * 1024.0), #add
                                                   server_result_data_higher_bound=(1 * 1024.0 * 1024.0),  #add
